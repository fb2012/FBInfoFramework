...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/fb2012/FBInfoFramework.git"
  ...
  spec.source       = { :git => "https://github.com/fb2012/FBInfoFramework.git", :tag => "#{spec.version}" }
  ...
  # spec.framework  = "SomeFramework"  'UIKit','Foundation'
